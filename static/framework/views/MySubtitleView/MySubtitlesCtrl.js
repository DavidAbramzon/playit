...
*/
app.controller('MySubtitlesCtrl', ['$scope', 'FileUploader','ApiService','MySubtitlesService','$uibModal',
function ($scope, FileUploader,ApiService,MySubtitlesService,$uibModal) {
    var init = function(){
